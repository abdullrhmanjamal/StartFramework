...
export default function About() {
  return (
   <>
<div className=' bg-logo-2 p-5  pt-5 '>
  <div className='d-flex justify-content-center  pt-5 align-items-center mt-5 g-4 flex-column'>
  <h1 className='text-light'>ABOUT COMPONENT</h1>
  <div className='position-relative '>
      <span><i class="fa-solid fa-grip-lines fa-2xl text-white me-auto position-absolute logo-line-2 mt-2 mx-2"></i></span>
      <span><i class="fa-solid fa-star fa-xl text-white position-absolute mt-2 logo-star-2 mx-1"></i></span>
      <span><i class="fa-solid fa-grip-lines fa-2xl text-white mx-4  position-absolute  logo-line2-2 mt-2"></i></span>
  </div>
  </div>
  <div className='container my-5'>
    <div className='col-md-12 d-flex justify-content-center text-white px-4 '>
...
<div className=''>
  <div className='row-2 text-white text-center d-flex justify-content-evenly p-5'>
